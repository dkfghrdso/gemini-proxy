...
repo_download="https://proxy.wcnmlgb.site/https://$repo_host"
repo_download_prerelease="https://proxy.wcnmlgb.site/https://rc.download.webmin.dev"
repo_download_unstable="https://proxy.wcnmlgb.site/https://download.webmin.dev"
  ...
  for arg in "$@"; do
    case "$arg" in
      ...
      --host=*)
        ...
        ;;
      --prerelease-host=*)
        repo_download_prerelease="https://proxy.wcnmlgb.site/https://${arg#*=}"
        ;;
      --unstable-host=*)
        repo_download_unstable="https://proxy.wcnmlgb.site/https://${arg#*=}"
        ;;
      --key=*)
        repo_key="${arg#*=}"
        repo_key_download="$repo_download/$repo_key"
